package org.zhenghao.application;
...
import static org.zhenghao.constants.Constants.LoginType.IS_PARTY_MEMBER;
import static org.zhenghao.constants.Constants.LoginType.IS_PUBLIC;
...
public final class UserManager {
    ...
    private static volatile UserManager instance; //不需要编译器优化
    private UserBean mUserBean;

    private UserManager() {
    }

    //懒汉式双重校验锁，只有在第一次new的时候才加锁，提高代码效率。
