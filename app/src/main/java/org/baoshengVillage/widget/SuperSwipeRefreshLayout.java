package org.baoshengVillage.widget;
...
//        LogUtil.d("debug:onLayout childHeight = " + childHeight);
    ...
    public boolean isChildScrollToBottom() {
        ...
        if (mTarget instanceof RecyclerView) {
            ...
            if (layoutManager instanceof LinearLayoutManager && count > 0) {
                ...
                final int comPos = linearLayoutManager.findLastCompletelyVisibleItemPosition();
                final int visPos = linearLayoutManager.findLastVisibleItemPosition();
                final int firPos = linearLayoutManager.findFirstVisibleItemPosition();
                if ((comPos == count - 1) || (comPos == RecyclerView.NO_POSITION && (firPos == count - 1 && visPos == count - 1))) {
                    return true;
                }
...
//                    LogUtil.d("Got ACTION_MOVE event but don't have an active pointer id.");
                    return false;
                }
