...
import org.baoshengVillage.mvp.presenter.fragment.MineFragment;
import org.baoshengVillage.mvp.presenter.fragment.NoticeFragment;
import org.baoshengVillage.mvp.view.MainActivityDelegate;
...
public class MainActivity extends ActivityPresenter<MainActivityDelegate> {
    ...
    private boolean doubleClickToQuit(int keyCode, KeyEvent event) {
        if (event.getKeyCode() == KeyEvent.KEYCODE_BACK) {
            if (!canFinish) {
                canFinish = true;
                ToastUtil.s(R.string.click_again);
